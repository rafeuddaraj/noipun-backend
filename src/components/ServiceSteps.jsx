...
export default function ServiceSteps() {
    return (
        <>
            ...
            <section
                className="container mx-auto my-8 flex flex-col product-card-item justify-center gap-3 lg:flex-row">
                {/* <!-- 1 --> */}
                ...
                <div
                    ...
                    <div
                        className="ml-6 flex flex-col product-card-item justify-center">
                        <h3 className="text-left text-xs font-bold lg:text-sm">
                            ফ্রি ডেলিভারি
                        </h3>
                        <p
                            className="text-light text-center text-xs lg:text-left lg:text-sm">
                            Orders from $200
                        </p>
                    </div>
                </div>
