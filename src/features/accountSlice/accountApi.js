...
import { login, updateUserData,logout } from "./accountSlice";
        ...
        login: builder.mutation({
            ...
            async onQueryStarted(arg,{queryFulfilled,dispatch}){
                try{
                    ...
                    if(response?.data?.accountStatus !== 'seller'){
                        dispatch(accountApi.endpoints.logout.initiate())
                        dispatch(logout())
                    }
                }catch{
                    //
