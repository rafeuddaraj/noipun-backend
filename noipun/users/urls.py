...
from .views import Login,RegisterView,Logout,GetUsers,SellerRegistrationView,SellerLogin,ForgetEmailInputView,ForgetPasswordView,EmailVerificationView,PasswordChangeView,UpdateProfileView,RequestEmailVerification
...
urlpatterns = [
    ...
    path('request-email-verification/',RequestEmailVerification.as_view(),name='request-email-verification'),
