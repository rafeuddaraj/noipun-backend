...
class Category(models.Model):
    ...
    modified = models.DateTimeField(auto_now=False,auto_now_add=True, editable=False,verbose_name='lastModified')
...
class Reviews(models.Model):
    ...
    product_id = models.ForeignKey(Product, on_delete=models.CASCADE,related_name = "review_product",verbose_name = "user")
