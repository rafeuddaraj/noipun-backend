...
class Category(models.Model):
    category_name = models.CharField(max_length=50,null=True,blank=True,verbose_name="Category_Name")
...
class Offers(models.Model):
    ...
    discount_name =  models.CharField( max_length=100,null=True,blank=True,verbose_name="Discount_Name")   
...
class Product(models.Model):
    ...
    product_title = models.CharField( max_length=100,null=True,blank=True,verbose_name="Product_Title")
    ...
    offers = models.ForeignKey(Offers, verbose_name="offers",on_delete=models.CASCADE)
    ...
    is_available = models.BooleanField(default=True,verbose_name="Available_Status",null=True,blank=True)
